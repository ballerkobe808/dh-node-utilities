 ...
 */
exports.incrementAlphaNumericString = function (number) {
  ...
  var currentIndex = characters.length - 1;

  // get the increment result.
  var result = incrementCharacter(characters[currentIndex]);
  ...
  while (result.overflow) {
    ...
    // we passed the beginning of the string. add another digit.
      ...
      // break out of the loop since we finished incementing the whole string.
      break;
    }
  }
