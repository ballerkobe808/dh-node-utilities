 ...
 * @constructor
 */
var ResponseObject = function (status, data, message, error, errorCode) {
 ...
 */
exports.buildResponseObject = function (status, data, message, error, errorCode) {
  // create a new response object.
  return new ResponseObject(status, data, message, error, errorCode);
};
