 ...
 * @constructor
 */
var ResponseObject = function (status, data, message, error, errorCode, runConvertFunction) {
  ...
  if (!_.isUndefined(data) && !_.isNull(data)) {
    ...
    if (runConvertFunction) {
      if (_.isObject(this.data)) {
        if (this.data.hasOwnProperty('convertForJSONResponse') && (typeof this.data.convertForJSONResponse === 'function')) {
          this.data.convertForJSONResponse();
        }

        for (var key in this.data) {
          if (this.data.hasOwnProperty(key) && !stringUtilities.isEmpty(this.data[key]) && this.data[key].hasOwnProperty('convertForJSONResponse') && (typeof this.data[key].convertForJSONResponse === 'function')) {
 ...
 */
exports.buildResponseObject = function (status, data, message, error, errorCode, runConvertFunction) {
